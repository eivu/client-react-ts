...
const faqItems: Faq[] = [
  {
    ...
    title: 'Do you have any plans to fix sign ups?',
    details:
    'Frankly no.  This is all a proof of concept and my security is for shit, the UX is meh at best, uploads only work via cli (and if you don\'t know what cli means that is exactly my point). However if I know you AND I like you ping me and I\'ll set you up with an account',
  },{
    title: 'How do I ping you?',
    details:
    'If you knew, you wouldn\'t have to ask',
  },{
    title: 'What features are next?',
    details:
    'Importing iTunes playlist (xml format only). Writing content directly from the net to s3'
  },
];
    ...
    <DefaultLayout>
      ...
      <ContentContainer>
        <div className="text-xl">
          <p>what you have before you is a labor of love {new Date().getFullYear() - 2015 } years in the making. It's gone through several total rewrites, reenvionings, and rearchitectings but its now a live thing before your very eyes</p>
          <br />
